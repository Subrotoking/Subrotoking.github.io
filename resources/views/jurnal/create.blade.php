    ...
    <br>
      <table>
        <div class="form-group">
            <tr>
            <td width="75px"></td>
            <td width="300px">{!! Form::label('id_User', 'USER') !!}</td>
            <td width="400px">@if(count($list_user)>0)
                      {!! Form::select('id',$list_user, null,
                      ['class'=>'form-control','id_User'=>'id','placeholder'=>'Pilih User']) !!}
                  @else
                      <p>tidak ada pilihan User</p>
                  @endif</td>
          </tr>
          <tr>
            <td width="75px"></td>
