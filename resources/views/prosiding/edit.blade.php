      ...
      <table>
        <div class="form-group">
          <tr>
            ...
            <td width="400px">{!! Form::text('namapengusul', null, ['class'=>'form-control']) !!}</td>
          </tr>
        </div>
        <div class="form-group">
          <tr>
            <td></td>
            <td>NIDN</td>
            <td>{!! Form::text('nidn', null, ['class'=>'form-control']) !!}</td>
          </tr>
        </div>
        <div class="form-group">
          <tr>
            <td></td>
            <td>NIP/NIK</td>
            <td>{!! Form::text('nip', null, ['class'=>'form-control']) !!}</td>
          </tr>
        </div>
        <div class="form-group">
          <tr>
    ...
    <table>
      ...
      <div class="form-group">
        <tr>
          ...
          <td>{!! Form::text('Tanggal_Penerbitan', null, ['class'=>'form-control']) !!}</td>
        </tr>
      <div class="form-group">
    </table>
  </div>
    ...
    <table>
      <div class="form-group">
        <tr>
          ...
          <td width="400px">{!! Form::text('Nama_Jurnal', null, ['class'=>'form-control']) !!}</td>
        </tr>
      </div>
      <div class="form-group">
        <tr>
