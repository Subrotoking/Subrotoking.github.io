...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        // $post = DB::table('posts')->join('users','posts.id','=','users.id')->where('id_User',[auth()->user()->id])->get();
        $post = Post::all();
        // $post = Post::orderBy('kontribusi', 'desc');
    	return view('jurnal.index', compact('post'));
    }
    ...
    public function create()
    {
        ...
        return view('jurnal.create',compact('list_user'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('jurnal.edit', ['post' => $post]);
    }
